                  ...
                  {product?.sizes?.map((item, index) => {
                    return (
                      <button
                        ...
                        className={`py-1 px-2 mb-2 mr-1 border hover:border-blue-400 dark:border-gray-400 hover:text-blue-600 dark:hover:border-gray-300 dark:text-gray-400 whitespace-nowrap ${
                          size === item
                            ? 'border-white text-gray-700 font-bold  bg-slate-300'
                            : 'bg-slate-500 dark:bg-gray-700 text-light-200 dark:text-gray-400'
                        }`}
                      >
                        {item}
                      </button>
